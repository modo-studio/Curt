...
func ~ (left: NSLayoutYAxisAnchor, right: NSLayoutYAxisAnchor) -> NSLayoutConstraint {
    let constraint = left.constraint(equalTo: right)
    constraint.isActive = true
    return constraint
}

func ~ (left: NSLayoutXAxisAnchor, right: NSLayoutXAxisAnchor) -> NSLayoutConstraint {
    let constraint = left.constraint(equalTo: right)
    constraint.isActive = true
    return constraint
}

func ~ (left: NSLayoutDimension, right: NSLayoutDimension) -> NSLayoutConstraint {
    let constraint = left.constraint(equalTo: right)
    constraint.isActive = true
    return constraint
}

func ~ (left: NSLayoutDimension, right: CGFloat) -> NSLayoutConstraint {
    let constraint = left.constraint(equalToConstant: right)
    constraint.isActive = true
    return constraint
}

func ~ (left: NSLayoutDimension, right: Int) -> NSLayoutConstraint {
...
func + (left: NSLayoutConstraint, right: CGFloat) -> NSLayoutConstraint {
    left.constant = right
    return left
}
func + (left: NSLayoutConstraint, right: Int) -> NSLayoutConstraint {
